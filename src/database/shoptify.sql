...
--
-- Host: 127.0.0.1
-- Generation Time: May 19, 2024 at 10:55 AM
...
(1, '1', '1', '1', '12345678900', '1', '1', '$2a$10$WcnKFLLy7oWBzaKim/dtB.6o5LVbtRSylzysmnka1Y.cghiIfCXLC', 'Admin', '', 'src/sampleProfiles/default_user_profile.png', '2024-05-17', 'Active');
...
--
ALTER TABLE `tbl_adminlogs`
  MODIFY `adminlogs_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
